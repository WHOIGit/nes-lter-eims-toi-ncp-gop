...
bottle_headers <- c("cruise", "datetime_utc","datetime_utc_matlab", "latitude_API", "longitude_API", "toi_source", "cast", "niskin", "depth", "depth_matlab", "O2_Ar_delta", "O2_Ar_ratio", "cap_Delta_17O", "d17O", "d18O", "iode_quality_flag")
...
write.csv(bottle_edi, here("eims-toi-transect", 'toi-transect-v3.csv'), row.names = FALSE)
...
#bottle_edi <- read.csv(here('eims-toi-transect/toi-transect-v3.csv'))
...
make_eml(path=project_folder,
         ...
         data.table=c('toi-transect.csv',
                      ...
                      'eims-transect-2019.csv', 'eims-transect-2021.csv', 'eims-transect-2020.csv', 'eims-transect-2022.csv'),
