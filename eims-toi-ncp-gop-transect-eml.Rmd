...
where <- this_pkg$folder[1]
gop <- this_pkg$gop_product[1]
ncp <- this_pkg$hifreq_product[1]

# write files for upload to EDI
write.csv(ncp_gop_edi, paste0(here(where, gop), ".csv"), row.names = FALSE) #gop-transect
write.csv(ncp_gop_edi, paste0(here(where, ncp), ".csv"), row.names = FALSE) #ncp-transect

#TODO: continue here with updating to yearly packages
#TODO: run above for 2019
