...
# ra_file <- c('eims-transect-2018.csv', 'eims-transect-2019.csv')
...
#file_descriptions <- c("Data product low-frequency triple oxygen isotopes and oxygen-argon ratio from rosette and underway bottles", "Data product high-frequency oxygen-argon dissolved gas ratio and biosaturation from underway EIMS measurements", "Data product high-frequency oxygen-argon dissolved gas ratio and biosaturation from underway EIMS measurements")
file_descriptions <- c("Data product low-frequency triple oxygen isotopes and oxygen-argon ratio from rosette and underway bottles", "Data product high-frequency oxygen-argon dissolved gas ratio and biosaturation from underway EIMS measurements")
...
# xlsx_to_template(metadata.path = metadata,
#                  output.path = project_folder,
#                  edi.filename = 'eims-transect-2018', 
#                  rights = "CCBY")
# # Make EML Templates
# xlsx_to_template(metadata.path = metadata,
#                  output.path = project_folder,
#                  edi.filename = 'eims-transect-2019', 
#                  rights = "CCBY")
# # underway samples
# xlsx_to_template(metadata.path = here(project_folder, "eims-transect"), 
#                  output.path = project_folder,
#                  edi.filename = 'eims-transect-2018.csv', 
#                  rights = "CCBY")
# # underway samples
# xlsx_to_template(metadata.path = here(project_folder, "eims-transect"), 
#                  output.path = project_folder,
#                  edi.filename = 'eims-transect-2019.csv', 
#                  rights = "CCBY")
# # Make EML Templates
# xlsx_to_template(metadata.path = metadata,
#                  output.path = project_folder,
#                  edi.filename = "eims-transect", 
#                  rights = "CCBY")
# underway samples
...
date_col <- as.Date(c(eims_all$datetime_utc_matlab,
                      bottle_edi$datetime_utc))
lat_col <- eims_all$latitude_matlab
lon_col <- eims_all$longitude_matlab
