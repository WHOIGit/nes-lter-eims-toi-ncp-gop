...
toi_input_files <- c("eims-toi-transect/bottleEN608.csv")
#toi_input_files <- c("eims-toi-transect/bottleEN627.csv")
#toi_input_files <- c("eims-toi-transect/bottleEN644.csv")
 # toi_input_files <- c("eims-toi-transect/bottleEN617withoutincubation.csv",
...
eims_input_files <- c("eims-toi-transect/RaEn608withbiosat.csv")
#eims_input_files <- c("eims-toi-transect/RaEn627withbiosat.csv")
#eims_input_files <- c("eims-toi-transect/RaEn644withbiosat.csv")
# eims_input_files <- c("eims-toi-transect/RaEn617withbiosat.csv",
...
eimshasdate$latitude_API <- NA_integer_
eimshasdate$longitude_API <- NA_integer_
...
ncp_gop_csv <- paste0(this_pkg$folder, "/", this_pkg$ncp_gop_input, ".csv")
ncp_hifreq_input <- paste0(this_pkg$folder, "/", this_pkg$ncp_hifreq_input, ".csv")
...
## this matching doesn't work for EN608 because 7 underway values are included in toi but not in discreterates input file
...
# write files for upload to EDI
write.csv(ncp_gop_edi, paste0(here(this_pkg$folder, this_pkg$gop_product), ".csv"), row.names = FALSE)
write.csv(ncp_hifreq_edi, paste0(here(this_pkg$folder, this_pkg$hifreq_product), ".csv"), row.names = FALSE)
...
# define input for EML assembly
metadata <- this_pkg$metadata_file
...
make_eml(path = here(project_folder),
         ...
         data.table.description = file_descriptions,
         other.entity = c(this_pkg$ncp_matlab, this_pkg$gop_matlab),
