...
add_parent(edi_pkg = pkg_id, parent_name = "parent_project_NESI-II_OOI.txt", xml.path = project_folder)
...
this_pkg <- cruise_list %>% filter(package_id == "knb-lter-nes.32.1")
...
make_eml(path = project_folder,
         ...
         geographic.description = "NES-LTER Transect",
         geographic.coordinates = geographic_coordinates(lat, long),
         maintenance.description = "ongoing", #TODO: add column in cruise list to designate completed pkgs
         user.id = "NES",
         user.domain = "LTER",
         package.id = pkg_id)
