...
bottle_headers <- c("datetime_utc", "datetime_utc_matlab", "latitude", "longitude", "toi_source", "cast", "niskin", "depth_mat_file", "depth_API_bottle_summary", "O2_Ar_delta", "O2_Ar_ratio", "cap_Delta_17", "delta_17", "delta_18")
ra_headers <- c("datetime_utc", "datetime_utc_matlab", "latitude", "longitude", "depth", "biosat", "O2_Ar_ratio")
...
ncp_headers <- c("datetime_utc", "datetime_utc_matlab", "latitude", "longitude", "depth", "biosat", "O2_Ar_ratio", "ncp", "k")
