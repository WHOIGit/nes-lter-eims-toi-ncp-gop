...
this_pkg <- cruise_list %>% filter(package_id == "knb-lter-nes.14.3")
...
#2/1/2018  18:12 	row 29, 2/3/2018  03:50	row 70
# AR28B underway
if (this_year == 2018){
...
diffrows <- anti_join(toi_transect_surface, ncp_gop_input,  by = "datetime_utc_input")
