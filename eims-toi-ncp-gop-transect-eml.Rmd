...
colnames(toi_input) <- c("datetime_utc", "O2_Ar_delta", "O2_Ar_ratio", "depth_matlab", "cap_Delta_17", "delta_17", "delta_18", "niskin")
colnames(eims_transect_input) <- c("datetime_utc", "O2_Ar_ratio", "temp", "sal", "latitude", "longitude", "cumulative_dist", "biosat")
eims_transect_input <- eims_transect_input %>% select(-cumulative_dist)
eims_transect_input$depth <- 5
                           
#convert datetime format
toi_input$datetime_utc <- as.POSIXct(toi_input$datetime_utc, format="%d-%b-%Y %H:%M:%OS")
eims_transect_input$datetime_utc <- as.POSIXct(eims_transect_input$datetime_utc, format="%d-%b-%Y %H:%M:%OS")
...
# plot to check datetime, latitude, longitude
ggplot(eims_transect_input, aes(x= datetime_utc, y = latitude))+ geom_point()
ggplot(eims_transect_input, aes(x= datetime_utc, y = longitude))+ geom_point()

ggplot(eims_transect_input, aes(x= datetime_utc, y = biosat))+ geom_point()
ggplot(eims_transect_input, aes(x= datetime_utc, y = O2_Ar_ratio))+ geom_point()
ggplot(eims_transect_input, aes(x= datetime_utc, y = temp))+ geom_point()

ggplot(toi_input, aes(x= datetime_utc, y = O2_Ar_ratio))+ geom_point()
ggplot(toi_input, aes(x= datetime_utc, y = O2_Ar_delta))+ geom_point()
ggplot(toi_input, aes(x= datetime_utc, y = cap_Delta_17))+ geom_point()
...
# map check
map_locs(df = eims_transect_input, xvar = "longitude", yvar = "latitude", region = "transect", colorvar = NULL)
...
#                                        "depth_matlab", "cap_Delta_17", "delta_17", "delta_18", "niskin","datetime_utc")
# colnames(RaEn617withbiosat) <- c("datetime_utc_matlab", "O2_Ar_ratio", "temp", "sal", "latitude", "longitude", "cum_dist", "biosat", "datetime_utc")
# 
...
bottle_headers <- c("datetime_utc", "latitude", "longitude", "toi_source", "cast", "niskin", "depth_matlab", "depth_API_bottle_summary", "O2_Ar_delta", "O2_Ar_ratio", "cap_Delta_17", "delta_17", "delta_18")
ra_headers <- c("datetime_utc", "latitude", "longitude", "depth", "biosat", "O2_Ar_ratio")
