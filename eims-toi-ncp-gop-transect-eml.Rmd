...
# for now, include in cruise_list only cruises to assemble 
...
ncp_gop_input <- ncp_gop_input %>%
   mutate(cast_flag = case_when(datetime_utc_matlab == "2019-08-22 00:57:00"  ~ 1, #EN644
...
# would be helpful to plot these on same x-axis (ie by time elapsed on cruise) and color by season
...
#project_folder <- paste0("ncp-gop-transect-", this_pkg$year[1], "-pkg", this_pkg$package_no[1])
