...
# underway <- read_from_api(type = "underway", cruises = unique(bottle$cruise))
# 
# # match to datetime
...
## they are the rows with provided Niskin 99 and Depth of 999. Need this hard coding if they are converted to values of 0 at outset. Don't need it if converted to NA. 
