...
#moved Matlab files to data subfolders and this is not working
files <- c(here("eims-toi-transect", 'bottleEn617withoutincubation.mat'))
#files <- Sys.glob("*.mat")
...
colnames(bottleEn617withoutincubation) <- c("datetime_utc_matlab", "O2_Ar_delta", "O2_Ar_ratio",
                                       "depth", "D17", "d17", "d18", "niskin","datetime_utc")
colnames(RaEn617withbiosat) <- c("matlab_date", "O2_Ar_ratio_corrected", "temp", "sal", "latitude", "longitude", "cum_dist", "biosat", "datetime_utc")
...
bottle$depth_diff <- bottle$depth - bottle$depth_api
...
bottle_headers <- c("datetime_utc", "datetime_utc_matlab", "latitude", "longitude", "toi_source", "cast", "niskin", "depth", "O2_Ar_delta", "O2_Ar_ratio", "D17", "d17", "d18")
ra_headers <- c("datetime_utc", "matlab_date", "latitude", "longitude", "depth", "temp", "sal", "biosat", "O2_Ar_ratio_corrected")
...
write.csv(bottle_edi, here("eims-toi-transect", 'RaEn617withbiosat.csv'), row.names = FALSE)
...
make_eml(path = project_folder,
         ...
         other.entity = c("bottleEn617withoutincubation.mat", "RaEn617withbiosat.mat"),
...
```{r}
# assign column headers
colnames(ncplterEn617) <- c("matlab_date", "O2_Ar_ratio_corrected", "temp", "sal", "latitude", "longitude",
                "cum_dist", "biosat", "ncp", "k","datetime_utc")
colnames(discreteratesEn617) <- c("matlab_date", "latitude", "longitude", "gop", "ncp",
...
rates_headers <- c("datetime_utc", "matlab_date", "latitude", "longitude", "gop", "ncp", "ncp_per_gop")
ncp_headers <- c("datetime_utc", "matlab_date", "latitude", "longitude", "depth", "temp", "sal", "biosat", "O2_Ar_ratio_corrected", "ncp", "k")
...
file_descriptions <- c("Discrete rates of NCP and GOP", "NCP derived from high frequency EIMS  sampling of underway")
